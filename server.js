...
const checkWorkingHours = (req, res, next) => {
    ...
    // Styles CSS pour le message d'indisponibilité
    const style = `
        zoom: 1;
        max-width: 1200px;
        margin: 0 auto;
